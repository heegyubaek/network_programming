...
//  |             4               |              4            |             4               | 
//   _________________________________________________________________________
//  |      time of capture        |   the max length of snap  |     datalink type        |
//  _________________________________________________________________________
...
#define MAGIC   0xa1b2c3d4 //pcap magic
    ...
    unsigned int sigfigs; /* accuracy oftimestamps */
    unsigned int snaplen;            /* maxlength savedportion of each pkt */
    unsigned int linktype;            /* datalink type (LINKTYPE_*) */
}pcap_file_header;
...
//  | seconds(4)       | micro seconds(4) |    the length of capture    |    the length of packet |
//  _______________________________________________________________________________ 
...
//   ____________________________________________________________________________
//  |         Sender H/W Address (variable , Ethernet 48bits, 6Bytes)                   |
//   ____________________________________________________________________________
//  |          Sender Protocol Address (variable, IP 32bits, 4Bytes)                     |
//   ____________________________________________________________________________
//  |          Target H/W Address (variable, Ethernet 48bits, 6Bytes)                   |
//   ____________________________________________________________________________
//  |            Target Protocol Address (variable, IP 32bits, 4Bytes)                    |
//   ____________________________________________________________________________
